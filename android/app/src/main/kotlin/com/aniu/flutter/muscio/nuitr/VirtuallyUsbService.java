...
public class VirtuallyUsbService extends Service {
...
//                {
//                    Log.d("UsbSerialInterface", "onReceivedData： "+ data+",Byte:" + String.valueOf(data.length()));
//                }
                if (mHandler != null && data.isEmpty() == false)//修复扫码结果发起2次回调问题
    ...
    public void onCreate() {
        this.context = this;
        serialPortConnected = false;
        VirtuallyUsbService.SERVICE_CONNECTED = true;
        setFilter();
    ...
    public void onDestroy() {
        super.onDestroy();
        VirtuallyUsbService.SERVICE_CONNECTED = false;
    }
...
//    }
    ...
    public class UsbBinder extends Binder {
        public VirtuallyUsbService getService() {
            return VirtuallyUsbService.this;
        }
    }
